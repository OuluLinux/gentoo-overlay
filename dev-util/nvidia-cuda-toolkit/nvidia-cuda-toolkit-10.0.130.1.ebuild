...
MYD=$(ver_cut 1-2)
DRIVER_PV="410.48"
# Real PV for the base installer
BASE_PV="10.0.130"

DESCRIPTION="NVIDIA CUDA Toolkit (compiler and friends) with patch 1"
HOMEPAGE="https://developer.nvidia.com/cuda-zone"
SRC_URI="https://developer.nvidia.com/compute/cuda/${MYD}/Prod/local_installers/cuda_${BASE_PV}_${DRIVER_PV}_linux -> cuda_${BASE_PV}_${DRIVER_PV}_linux.run
	http://developer.download.nvidia.com/compute/cuda/${MYD}/Prod/patches/1/cuda_${PV}_linux.run"
...
src_unpack() {
	unpacker "cuda_${BASE_PV}_${DRIVER_PV}_linux.run"
...
src_install() {
	...
	use debugger || remove+=( bin/cuda-gdb extras/Debugger extras/cuda-gdb-${BASE_PV}.src.tar.gz )
