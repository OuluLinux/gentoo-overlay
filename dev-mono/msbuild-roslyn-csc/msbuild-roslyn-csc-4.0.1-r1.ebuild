...
COMMON_DEPEND=">=dev-lang/mono-6.12.0.178 <dev-lang/mono-9999
		msbuild_targets_msbuild17-14? (
			dev-dotnet/msbuild-tasks-api:17.14
			dev-dotnet/msbuild-defaulttasks:17.14
		)
"
...
src_prepare() {
	if ! use msbuild_targets_msbuild17-14 ; then
...
src_references() {
 echo -n " $(reference_dependency Microsoft.Build.Framework-17.14) "
 echo -n " $(reference_dependency Microsoft.Build.Tasks-17.14) "
}
